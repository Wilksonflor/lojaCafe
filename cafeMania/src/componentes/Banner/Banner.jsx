import imgBanner from "../../assets/img/pngwing.com.png";
...
export const Banner = () => {
  return (
    <>
      <div style={bgImage}>
        <div className="container min-h-[550px] flex justify-center items-center py-12 sm:py-0 overflow-hidden sm:py-10">
              ...
              <div className="grid grid-cols-2 gap-6 mt-5">
                <div className="space-y-5 ">
                  ...
                  <div
                    ...
                    data-aos-delay="300"
                  >
                    <IoFastFood className="text-2xl h-14 w-14  shadow-sm p-3 rounded-full bg-blue-100 " />
                    <span>Combine seu café com os melhores lanches</span>
                  </div>
                </div>

                <div
                  className="border-l-4 border-primary/50 pl-6 space-y-3 sm:pl-3"
                  data-aos="fade-up"
                  data-aos-delay="300"
                >
                  <h3
